...
@interface _INUIControlBlockTarget : NSObject
...
@implementation _INUIControlBlockTarget
...
- (void)addBlockForControlEvents:(UIControlEvents)controlEvents
    ...
    _INUIControlBlockTarget *target = [[_INUIControlBlockTarget alloc]
...
- (void)removeAllBlocksForControlEvents:(UIControlEvents)controlEvents {
    ...
    [targets enumerateObjectsUsingBlock: ^(id obj, NSUInteger idx, BOOL *stop) {
        _INUIControlBlockTarget *target = (_INUIControlBlockTarget *)obj;
